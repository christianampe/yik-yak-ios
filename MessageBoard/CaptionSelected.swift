...
class CaptionSelected : UIViewController, UITextFieldDelegate {
    ...
    @IBAction func sendPost(_ sender: AnyObject) {
        ...
        if reachability.currentReachabilityStatus == .notReachable {
            ...
            Database().postToDatabase(image: image!, imageName: "aaaaupload.jpg", text: textField.text!, location: PostVariables.postLocation!, city: PostVariables.postCity!, state: PostVariables.postState!, country: PostVariables.postCountry!)
            textField.resignFirstResponder()
            self.performSegue(withIdentifier: "unwindselected", sender: self)
        }
            ...
            Database().commentToDatabase(image: image!, imageName: "aaaaupload.jpg", parent: CommentVariables.commentParent!, text: textField.text!, location: CommentVariables.commentLocation!, city: CommentVariables.commentCity!, state: CommentVariables.commentState!, country: CommentVariables.commentCountry!)
            textField.resignFirstResponder()
            self.performSegue(withIdentifier: "unwindselected", sender: self)
        }
        else {
